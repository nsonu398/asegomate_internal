...
export const AddOnsSelectionScreen: React.FC = () => {
  ...
  const selectedAddOnsTotal = addOns.filter(addon => addon.isSelected).reduce((sum, addon) => sum + addon.price, 0);
      ...
      >
        ...
        >
          <View style={[
            styles.checkbox,
            {
              backgroundColor: sameAddOnsAsTraveller1 ? theme.colors.primary.main : 'transparent',
              borderColor: sameAddOnsAsTraveller1 ? theme.colors.primary.main : theme.colors.neutral.gray400
            }
          ]}>
        ...
        <View style={[styles.searchContainer, { 
          ...
          <Ionicons name="search" size={20} color={theme.colors.neutral.gray500} style={styles.searchIcon} />
          <Text style={[styles.searchPlaceholder, { color: theme.colors.neutral.gray500 }]}>
            Search Add - Ons
          </Text>
        </View>
            ...
            >
              <View style={styles.addOnContent}>
                <View style={styles.addOnInfo}>
                  <Text style={[styles.addOnName, { color: theme.colors.neutral.gray900 }]}>
                    {addon.name}
                  </Text>
                  {addon.note && (
                    <Text style={[styles.addOnNote, { color: theme.colors.secondary.main }]}>
                      {addon.note}
                    </Text>
                  )}
                  <Text style={[styles.addOnPriceLabel, { color: theme.colors.neutral.gray500 }]}>
                    NO. OF TRAVELLER
                  </Text>
                  <Text style={[styles.addOnPrice, { color: theme.colors.neutral.gray900 }]}>
                    ₹{addon.price}
                  </Text>
                </View>
                ...
                <View style={styles.addOnAction}>
                  {addon.isSelected ? (
                    ...
                    >
                      <Ionicons name="remove" size={16} color={theme.colors.secondary.main} />
                      <Text style={[styles.removeButtonText, { color: theme.colors.secondary.main }]}>
                        Remove
                      </Text>
                    </TouchableOpacity>
                  ) : (
                    <TouchableOpacity 
                      ...
                      onPress={() => handleAddOnToggle(addon.id)}
                    >
                      <Ionicons name="add" size={16} color={theme.colors.primary.main} />
