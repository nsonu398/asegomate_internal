...
export const TripDetailsScreen: React.FC = () => {
  ...
  const { countries, regions, isLoading: isMasterLoading } = useMasterData();
  ...
  const handleDestinationPress = () => {
    if (tripDetails.region != "") {
      router.push({
        ...
        params: {
          countryRegion:
            tripDetails.region.toLowerCase() ===
  ...
  const handleStartDatePress = () => {
    // Set the callback before navigating
    setCalendarCallback((date: string) => {
      setStartDate(date);
    });
  ...
  const handleTravellersPress = () => {
    ...
    const newCount =
      tripDetails.numberOfTravellers < 5
  ...
  const [regionDropdownVisible, setRegionDropdownVisible] =
    ...
    >
        ...
        <View style={styles.section}>
          ...
          >
            <View style={styles.selectButtonContent}>
              ...
              >
                {tripDetails.destination?.countryName || "Choose a Destination"}
              </Text>
            </View>
            <Ionicons
              name="chevron-down"
        ...
        <View style={styles.dateContainer}>
            ...
            >
              ...
              >
                {tripDetails.startDate
                  ? formatDateForDisplay(tripDetails.startDate)
                  : "Start Date"}
              </Text>
            </TouchableOpacity>
          ...
          <View style={styles.dateSection}>
            ...
            >
              ...
              >
                {tripDetails.endDate
                  ? formatDateForDisplay(tripDetails.endDate)
                  : "End Date"}
              </Text>
            </TouchableOpacity>
                  ...
                  styles.selectButtonText,
                  {
                    color:
                      tripDetails.numberOfTravellers > 0
                        ...
                        : theme.colors.neutral.gray500,
                    fontWeight:
                      tripDetails.numberOfTravellers > 0 ? "500" : "400",
                  },
                ]}
              >
                {tripDetails.numberOfTravellers > 0
                  ? `${tripDetails.numberOfTravellers} Traveller${
                      tripDetails.numberOfTravellers > 1 ? "s" : ""
                    }`
      ...
      <View
        style={[
          ...
          {
            backgroundColor: theme.colors.neutral.gray100,
            borderTopColor: theme.colors.neutral.gray400,
          },
        ]}
      >
        <Button
